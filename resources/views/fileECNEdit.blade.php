                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 mb-3">
                                        <label>ECN編號<span style="color: red;">*必填</span></label>
                                ...
                                <div class="form-row" id="">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="fa fa-calendar-minus-o">備註</label>
                                ...
                                <div class="form-row">
                                    <div class="col-md-2 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" value="" id="modification_date">
                                        </div>
                                    </div>
                                    <div class="col-md-2 mb-3">
